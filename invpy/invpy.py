...
def getpairID(keyword):
    ...
    url = 'https://cn.investing.com/search/service/search'
    post_data = {
...
#%%
def gethisData(keyword,start,end,interval = 'Daily'):
    '''
...
if __name__=='__main__':
    ...
    hs300 = gethisData('石油','2018/04/01','2018/05/10')
